 ...
 * @since 1.0
 */
public class ArrayLongList extends AbstractLongList  {
	...
	public ArrayLongList(Collection<Long> coll) {
		...
		if (coll == null) {
			...
			final ArrayLongList c = (ArrayLongList) coll;
	...
	protected void ensureCapacity(int capacity) {
		...
		final long[] newArray = new long[newLen];
		System.arraycopy(data, 0, newArray, 0, len);
		data = newArray;
	}

	@Override
	public LongFlow iter() {
		return new FlowFromValues.OfLong(data);
	}

	@Override
	public LongFlow rIter() {
		return new ReverseFlowFromValues.OfLong(data);
	}
}
