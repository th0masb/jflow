...
public interface DoubleFlow extends PrototypeDoubleFlow
{
	 ...
	 * @return Let {@code F} denote the source {@link DoubleFlow}. We return an IntFlow
	 ...
	 *         consisting of the first {@code n} elements of the source DoubleFlow. If
	 ...
	 *         DoubleFlow which pass the test defined by the parameter predicate. The
	 ...
	 * @return an {@link DoubleFlow} consisting of the elements of the source DoubleFlow
	 ...
	 * @param other
	 *            - A varargs double array
	 * @return an {@link DoubleFlow} consisting of the elements in the parameter array
	 ...
	 * @return If we denote the source DoubleFlow by {@code F}, the length of {@code F}
	 ...
	 *         the source DoubleFlow, say {@code e}, is associated to the key value pair
	 *         {@code (k(e), v(e))}.<br>
	 *         <br>
	 *         If two different elements of the source DoubleFlow map to the same key
	 ...
	 *         source DoubleFlow who have equal (under .equals() contract) images under
