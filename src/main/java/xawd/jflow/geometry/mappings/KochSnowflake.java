...
public final class KochSnowflake
{
	...
	public static Polygon getEquilateralTriangle(double sideLength)
	{
		...
		final PointMap rotate60 = Rotation.of(COS60, SIN60, firstCorner);
		final Point thirdCorner = rotate60.apply(secondCorner);
		return new Polygon(Iter.of(firstCorner, thirdCorner, secondCorner));
	}
	...
	public static Flow<LineSegment> recurseRight(LineSegment source)
	{
		...
		final Point rotated = Rotation.of(COS60, SIN60, oneThirdUp).apply(twoThirdsUp);
		return Iter.of(
