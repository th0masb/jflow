...
{
	/**
	 * Applies a function elementwise to this {@link IntIterator} to make
	 ...
	 *         of this {@link IntIterator} instance in turn.
	 */
	...
	/**
	 * Applies a function elementwise to this {@link IntIterator} to make a
	...
	/**
	 * Combines this {@link IntIterator} with an iterator to create a new
	 ...
	 * @param other The Iterator to zip this source {@link IntIterator}
	 *              with.
	 *
	...
	/**
	 * Combines this {@link IntIterator} with another primitive iterator to
	 ...
	 * {@link IntIterator} to a pair consisting of the element and the index
	 * it appears.
	 *
	 * @return Denote this source {@link IntIterator} by {@code F}. We
	 ...
	 * {@link IntIterator} by selecting elements with indices defined by the
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by selecting the first n elements.
	 *
	 * @param n A non-negative integer.
	 * @throws IllegalArgumentException If parameter is negative.
	 * @return Let {@code F} denote this source {@link IntIterator}. We
	 *         return a {@link IntIterator} consisting of the first
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by selecting elements until an element fails the
	 ...
	 *         {@link IntIterator} consisting of the first {@code n}
	 *         elements of this source {@link IntIterator}. If no element
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by removing the first n elements.
	 *
	 * @param n A non-negative integer.
	 * @throws IllegalArgumentException If parameter is negative.
	 * @return Let {@code F} denote this source {@link IntIterator}. We
	 *         return a {@link IntIterator} missing the first
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by removing elements until an element fails the
	 * supplied test, the first failure is the first element of the result.
	 *
	 * @param predicate An IntPredicate.
	 * @return Let {@code n} be the index of the first element that the parameter
	 *         predicate fails for. Then this method returns a
	 *         {@link IntIterator} missing {@code n} elements of this source
	 *         {@link IntIterator}. If no element fails the predicate test
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by removing any element which fails the supplied
	 * predicate test.
	 *
	 * @param predicate A IntPredicate.
	 * @return An {@link IntIterator} containing only those elements of this
	 *         source {@link IntIterator} which pass the test defined by the
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by adding each element of the supplied primitive
	 * iterator to its end in order.
	 *
	 * @param other A primitive iterator.
	 * @return An {@link IntIterator} consisting of the elements of this
	 *         source {@link IntIterator} followed by the elements of the
	...
	/**
	 * Creates a new {@link IntIterator} from this
	 * {@link IntIterator} by adding each element of the supplied varargs
	 * array to its end in order.
	 *
	 * @param other - A varargs int array
	 * @return An {@link IntIterator} consisting of the elements of the
	 *         source {@link IntIterator} followed by the elements in the
	 *         parameter array.
	 */
	IntIterator append(int... other);

	/**
	 * Creates a new {@link IntIterator} from this Iterator by adding each
	 * element to the end of the supplied primitive iterator in order.
	 *
	 * @param other A primitive iterator.
	 * @return a {@link IntIterator} consisting of the elements of the
	 ...
	 *
	 * @param other - A varargs int array
	 * @return an {@link IntIterator} consisting of the elements in the
	...
	/**
	 * Applies an accumulation operation to this {@link IntIterator} to
	 * produce a new {@link IntIterator}.
	 *
	 * @param accumulator The accumulation function.
	 * @return Let {@code F} denote this source {@link IntIterator} and
	 *         {@code g} denote the accumulation function. Then the
	 *         {@link IntIterator} returned is of the form:
	 *         <ul>
	 ...
	 *                     empty.
	 *
	 * @return the smallest element in this {@link IntIterator} or the
	 *         default value if the iteration is empty.
	 */
	int min(int defaultValue);

	/**
	 * Calculates the minimum element in this {@link IntIterator} by a
	 ...
	 *            {@link IntIterator} to some data type with an ordering.
	 * @return The element of this {@link IntIterator} whose image under the
	 ...
	 *                     empty.
	 *
	 * @return The largest element in this {@link IntIterator} or the
	 *         default value if the iteration is empty.
	 */
	int max(int defaultValue);

	/**
	 * Calculates the maximum element in this {@link IntIterator} by a
	 * mapping to a type equipped with a natural ordering.
	 *
	 * This method is a 'consuming method', i.e. it will iterate through this
	 * {@link IntIterator}.
	 ...
	 * {@link IntIterator}.
	 *
	 * @return True is every element of this {@link IntIterator} is equal,
	 *         false otherwise.
	 */
	boolean areAllEqual();

	/**
	 * Checks whether every element in this {@link IntIterator} passes the
	...
	/**
	 * Checks whether any element in this {@link IntIterator} passes the
	 * supplied IntPredicate test.
	 *
	 * This method is a 'consuming method', i.e. it will iterate through this
	 * {@link IntIterator}.
	...
	/**
	 * Checks whether every element in this {@link IntIterator} fails the
	 * supplied IntPredicate test.
	 *
	 * This method is a 'consuming method', i.e. it will iterate through this
	 * {@link IntIterator}.
	 ...
	 * @return If we denote this source {@link IntIterator} by {@code F},
	 ...
	 *
	 * @param reducer The reduction function
	 * @return Let us denote this source {@link IntIterator} by {@code F},
	 *         the length of {@code F} by {@code n} and the reduction function by
	 ...
	 *         {@link IntIterator} with their ordering retained.
	 */
	int[] toArray();

	/**
	 * Builds a Map using the elements in this {@link IntIterator} via two
	 * supplied functions.
	 *
	 * This method is a 'consuming method', i.e. it will iterate through this
	 * {@link IntIterator}.
	 ...
	 *                               {@link IntIterator} map to the same
	 *                               key.
	 *
	 ...
	 *         </ul>
	 *         an element of this source {@link IntIterator}, say {@code e},
	...
	/**
	 * Groups elements in this {@link IntIterator} via their image under
	 ...
	 *         {@link IntIterator} via the classification function. Elements
	 *         in this source {@link IntIterator} who have equal (under
	 ...
	 *                {@link IntIterator} instances of this element type.
	 ...
	 *
	 * @return a copy of this source {@link IntIterator} as a Iterator of
