...
/**
 * Static methods for building infinite iterators.
 * 
 * @author ThomasB
 */
public class Repeatedly
{
	...
	// * application.
	// */
	// public static IntIterator applyInts(IntUnaryOperator applicationOperator, int
	// initialValue)
	// {
	...
	// *
	// * @param source The sequence which will be continuously looped over.
	// * @return An IntEnhancedIterator which continuously loops through the
	// elements
	...
	// * application.
	// */
	// public static DoubleIterator applyDoubles(DoubleUnaryOperator
	// applicationOperator,
	// double initialValue)
	// {
	...
	// * application.
	// */
	// public static LongIterator applyLongs(LongUnaryOperator applicationOperator,
	// long initialValue)
	// {
	...
	// *
	// * @param source The sequence which will be continuously looped over.
	// * @return An LongEnhancedIterator which continuously loops through the
	// elements
	// * of the source sequence.
	// */
