...
public interface IntIterator extends OptionalIntIterator
{
     ...
     * @param f   A mapping function.
     * @return A new Iterator instance whose elements are obtained by applying
     * the parameter mapping function to each element of this {@link
     * IntIterator} instance in turn.
     */
     ...
     * create a new Iterator consisting of pairs of elements with the same index
    ...
    /**
     * Creates a new Iterator by mapping each element in this source {@link
     * IntIterator} to a pair consisting of the element and the index it
     * appears.
     *
     * @return Denote this source {@link IntIterator} by {@code F}. We return a
    ...
    /**
     * Creates a new {@link IntIterator} from this {@link IntIterator} by
     ...
     *                 -> N}
     * @return Let {@code F} denote this source {@link IntIterator}, let {@code
     ...
     * IntIterator} consisting of the first {@code n} elements of this source
     * {@link IntIterator}. If no element fails the predicate test then a copy
     ...
     * @param n A non-negative integer.
     * @return Let {@code F} denote this source {@link IntIterator}. We return a
     * {@link IntIterator} missing the first {@code min(n, length(F))} elements
     * of {@code F}.
     * @throws IllegalArgumentException If parameter is negative.
     */
     ...
     * @return Let {@code n} be the index of the first element that the
     * parameter predicate fails for. Then this method returns a {@link
     * IntIterator} missing {@code n} elements of this source {@link
     * IntIterator}. If no element fails the predicate test then a copy of the
     * source is returned.
     */
     ...
     * source {@link IntIterator} which pass the test defined by the parameter
     ...
     * {@link IntIterator} followed by the elements of the parameter primitive
     * iterator.
     */
     ...
     * primitive iterator followed by the elements of this source {@link
     * IntIterator}.
     */
     ...
     * {@link IntIterator}.
     *
     * @return the smallest element in this {@link IntIterator} or the default
     * value if the iteration is empty.
     */
    int min();

    /**
     * Calculates the minimum element in this {@link IntIterator} by a mapping
     * to a type equipped with a natural ordering.
     *
     * This method is a 'consuming method', i.e. it will iterate through this
     * {@link IntIterator}.
     *
     ...
     * {@link IntIterator}.
     *
     * @return The largest element in this {@link IntIterator} or the default
     * value if the iteration is empty.
     */
    int max();

    /**
     * Calculates the maximum element in this {@link IntIterator} by a mapping
     * to a type equipped with a natural ordering.
     *
     * This method is a 'consuming method', i.e. it will iterate through this
     * {@link IntIterator}.
     ...
     * @return If we denote this source {@link IntIterator} by {@code F}, the
     ...
     * {@link IntIterator}.
     *
     * @return A long array containing all elements of this {@link IntIterator}
