...
public interface RichIterator<E> extends OptionalIterator<E>
{
     ...
     * parameter sequence denoted by {@code I}. We return a new {@link
     ...
     *
     * @param <R>   The upper type bound on the parameter {@link RichIterator}.
     * @param other The {@link RichIterator} to zip this source {@link
     *              RichIterator} with.
     * @return Denote this source {@link RichIterator} by {@code F} with the
    ...
    /**
     * Combines this iterator with another via an 'interleaving' operation.
     * Elements are taken from the head of the two sources in turn (beginning
     * with this iterator) until one of the sources is exhausted at which point
     * the interleave iterator is considered exhausted too.
     *
     ...
     * returns a {@link RichIterator} {@code G} given by:
     * <ul>
     ...
     * a {@link RichIterator} consisting of the first {@code max(n, length(F))}
     * elements of {@code F}.
     ...
     * RichIterator} consisting of the first {@code n} elements of this source
     ...
     * @param n A non-negative integer.
     * @return Let {@code F} denote this source {@link RichIterator}. We return
     * a {@link RichIterator} missing the first {@code min(n, length(F))}
     * elements of {@code F}.
     * @throws IllegalArgumentException If parameter is negative.
     */
     ...
     * @return Let {@code n} be the index of the first element that the
     * parameter predicate fails for. Then this method returns a {@link
     * RichIterator} missing {@code n} elements of this source {@link
     ...
     * {@link RichIterator} followed by the elements of the parameter {@link
     * RichIterator}.
     */
     ...
     * parameter {@link RichIterator} followed by the elements of this source
     * {@link RichIterator}.
     */
    ...
    /**
     * Convenience method for inserting a single element into the beginning of
     ...
     * @return Let {@code F} denote this source {@link RichIterator} and {@code
     * g} denote the accumulation function. Then the {@link RichIterator}
     ...
     * predicate returns true. If there is no such element then an exception
    ...
    /**
     * Finds the first element in traversed by this iterator for which the given
     * predicate returns true. If there is no such element then nothing is
     ...
     * function and an initial value. This method is a 'consuming method', i.e.
     ...
     * returning an {@link Optional}. This method is a 'consuming method', i.e.
     * it will iterate through this {@link RichIterator}.
     *
     * @param reducer The reduction function.
     ...
     * method is a 'consuming method', i.e. it will iterate through this {@link
     * RichIterator}.
     *
     * @param reducer The reduction function.
     * @return Let us denote this source {@link RichIterator} by {@code F}, the
     ...
     * is a 'consuming method', i.e. it will iterate through this {@link
     * RichIterator}.
     *
    ...
    /**
     * Consumes this iterator using the supplied collection function to create a
     ...
     *                  iterator.
     * @return The result of the collection function applied to this {@link
     * RichIterator}.
     */
...
//	<R> R collect(IteratorCollector2<? super E, ? extends R> collector);
     ...
     * the provided function to it. The result is similar to {@link
     * #toMap(Function, Function)} with the first argument being the identity
     * function. If duplicate elements appear in this iterator then an exception
     * will be thrown.
     *
     * @param <V>         The type of values in the resulting map.
     * @param valueMapper the function which produces the associated values in
     *                    the resultant map for each unique element in this
     *                    iterator.
     ...
     * supplied functions. This method is a 'consuming method', i.e. it will
     ...
     * @param keyMapper   A function mapping elements of this {@link
     *                    RichIterator} to elements of the key type.
     * @param valueMapper A function mapping elements of this {@link
     *                    RichIterator} to elements of the value type.
     * @return A Map instance whose key-value pairs have a 1-to-1 correspondence
     * with the elements in this source {@link RichIterator}. More specifically
     * if:
     * <ul>
     ...
     * @throws IllegalStateException If two elements of this {@link
     *                               RichIterator} map to the same key.
     */
     ...
     * supplied classification function. This method is a 'consuming method',
     * i.e. it will iterate through this {@link RichIterator}.
     *
     ...
     * {@link RichIterator} via the classification function. Elements in this
     * source {@link RichIterator} who have equal (under .equals() contract)
     * images under the classification function are grouped together in a {@link
     * List} accessed by their shared classification key.
     */
     ...
     * 'consuming method', i.e. it will iterate through this {@link
     * RichIterator}.
     *
    ...
    /**
     * Caches the elements in this iterator to a Set which is accessible through
     ...
     * RichIterator}.
     *
     * @return A List instance containing all elements of the source flow with
     * their order retained.
     */
    ...
    /**
     * Caches the elements in this iterator to a List which is accessible
     * through an unmodifiable view.
     *
     * @return An unmodifiable view of the result of {@link
     * RichIterator#toList()}.
     */
     ...
     * @param keyMapper   The function mapping the elements of this iterator to
     *                    the keys of the resulting map.
     * @param valueMapper The function mapping the elements of this iterator to
     *                    the values of the resulting map.
     * @return An immutable view of the result of {@link RichIterator#toMap(Function,
     * Function)}.
     */
    ...
    /**
     * Append two iterators in turn to the end of this iterator. See {@link
     * #chain(Iterator)}.
     *
    ...
    /**
     * Append three iterators in turn to the end of this iterator. See {@link
     * #chain(Iterator)}.
     *
     * @param first  The first iterator to append
     * @param second The second iterator to append
