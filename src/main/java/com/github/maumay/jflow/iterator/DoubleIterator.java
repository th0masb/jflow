...
public interface DoubleIterator extends OptionalDoubleIterator
{
     ...
     * DoubleIterator} instance in turn.
     */
    ...
    /**
     * Applies a function elementwise to this {@link DoubleIterator} to make a
     ...
     * DoubleIterator} to a pair consisting of the element and the index it
     * appears.
     *
     * @return Denote this source {@link DoubleIterator} by {@code F}. We return
     * a new Iterator instance {@code G} defined by:
     * <ul>
     ...
     * return a {@link DoubleIterator} consisting of the first {@code max(n,
     * length(F))} elements of {@code F}.
     ...
     * DoubleIterator} consisting of the first {@code n} elements of this source
     ...
     * @param n A non-negative integer.
     * @return Let {@code F} denote this source {@link DoubleIterator}. We
     * return a {@link DoubleIterator} missing the first {@code min(n,
     * length(F))} elements of {@code F}.
     * @throws IllegalArgumentException If parameter is negative.
     */
     ...
     * @return Let {@code n} be the index of the first element that the
     * parameter predicate fails for. Then this method returns a {@link
     * DoubleIterator} missing {@code n} elements of this source {@link
     * DoubleIterator}. If no element fails the predicate test then a copy of
     ...
     * source {@link DoubleIterator} followed by the elements of the parameter
     ...
     * {@link DoubleIterator} followed by the elements in the parameter array.
     */
     ...
     * {@code g}     denote the accumulation function. Then the {@link
     * DoubleIterator} returned is of the form:
     * <ul>
     ...
     * {@link DoubleIterator}.
     *
     * @return an OptionalDouble wrapping the smallest element in this {@link
     * DoubleIterator} or nothing if the iteration is empty.
     */
     ...
     * {@link DoubleIterator}.
     *
     * @return an OptionalDouble wrapping the largest element in this {@link
     * DoubleIterator} or nothing if the iteration is empty.
     */
     ...
     * according to the equality contract: {@link Double#compare(double,
     * double)}.
     *
     * This method is a 'consuming method', i.e. it will iterate through this
     * {@link DoubleIterator}.
     *
     * @return True is every element of this {@link DoubleIterator} is equal,
     * false otherwise.
     */
    boolean areAllEqual();
     ...
     *
     * @param reducer The reduction function
     * @return Let us denote this source {@link DoubleIterator} by {@code F},
     * the length of {@code F} by {@code n} and the reduction function by {@code
     * f}. If {@code n == 0} we return nothing, else we return: <br>
     * <br>
     ...
     * {@link DoubleIterator}.
     *
     * @return A vector containing all elements of this {@link DoubleIterator}
     ...
     * {@link DoubleIterator}.
     *
     * @return A double array containing all elements of this {@link
     * DoubleIterator} with their ordering retained.
     */
    double[] toArray();
