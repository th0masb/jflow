...
public final class IntReductionConsumption
{
    ...
    public static OptionalInt foldOption(AbstractIntIterator source,
            IntBinaryOperator reducer)
    {
        ...
        return reductionUninitialised ? OptionalInt.empty() : OptionalInt
                .of(reduction);
    }

    public static int fold(AbstractIntIterator source,
            IntBinaryOperator reducer)
    {
        source.relinquishOwnership();
        boolean reductionUninitialised = true;
    ...
    public static int fold(AbstractIntIterator source, int id,
            IntBinaryOperator reducer)
    {
        source.relinquishOwnership();
        int reduction = id;
