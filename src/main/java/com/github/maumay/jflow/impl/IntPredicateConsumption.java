...
public final class IntPredicateConsumption
{
    ...
    public static boolean allMatch(AbstractIntIterator source,
    ...
    public static boolean anyMatch(AbstractIntIterator source,
            IntPredicate predicate)
    {
        source.relinquishOwnership();
        while (source.hasNext()) {
    ...
    public static boolean noneMatch(AbstractIntIterator source,
            IntPredicate predicate)
    {
        source.relinquishOwnership();
        while (source.hasNext()) {
