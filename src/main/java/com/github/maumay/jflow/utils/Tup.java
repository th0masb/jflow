...
public final class Tup<T, U>
{
    ...
    /**
     * Retrieve the first (left) element of the pair. Note this is the Scala
    ...
    /**
     * Maps this tuple to a new instance by applying the two mapping functions
     * to the left and right elements respectively.
     *
     * @param <S>       The left type of the new tuple.
     * @param <R>       The right type of the new tuple.
     * @param leftFunc  The function to apply to the first (left) element of
     *                  this tuple.
     * @param rightFunc The function to apply to the second (right) element of
     *                  this tuple.
     ...
     *             tuple.
     * @return A new tuple whose left element is the same as this tuple and
     * whose right element is the image of the right element of this tuple under
     ...
     *
     * @param <S>  The left type of the new tuple.
     * @param func The function to apply to the first (left) element of this
     *             tuple.
     * @return A new tuple whose right element is the same as this tuple and
     * whose left element is the image of the left element of this tuple under
     * the supplied function.
     */
     ...
     *
     * @return A tuple whose first element is this tuples second and whose
     * second element is this tuples first.
     */
    public Tup<U, T> flip()
    {
        return Tup.of(_2, _1);
