...
public class StraightSegment// extends AbstractSplineSegment
{
	...
	// }
	//
	// protected StraightSegment(final StraightSegment src, final Point3D
	// peturbation)
	// {
	...
	// {
	// final Point2D start =
	// coordinateTransform.map(getStart().translate(perturbation));
	// final Point2D end =
	// coordinateTransform.map(getEnd().translate(perturbation));
	// gc.beginPath();
	...
	// {
	// return t -> new Point3D((1 - t)*getStart().getX() + t*getEnd().getX(), (1 -
	// t)*getStart().getY() + t*getEnd().getY(), 0);
	// }
	//
	// @Override
	...
	// }
	//
	// public static StraightSegment scale(final Point3D start, final Point3D end,
	...
	// {
	// final StraightSegment a = new StraightSegment(new Point3D(0, 0, 0), new
	// Point3D(1, 0, 0));
