...
/**
 * An instance of this class is designed to be attached to a single instance of {@link IPolyEdge}
 * (say P with endpoints a := 'from' and b := 'to') which represents the points in space at which P bends.
 * The points contained in this class, say p0,....,pn ,  are ordered such that the constituent lines of
 * the edge are {(a, p0), (p0, p1), .... , (pn, b)}. It is reversible to allow for directed edges.
 *
 * @author ThomasB
 * @since 17 May 2017
 */
public class EdgeLayoutPoints implements Iterable<Point3D>, IDataStreamSerializable
{
	...
	public EdgeLayoutPoints(final List<Point3D> knotPoints, final boolean reversed)
	{
		this(knotPoints);
		isReversed = reversed;
	}
	...
	/**
	 * Adds the parameter point to be the closest to the current 'to' vertex of this edge.
	 * @param point
	 */
	...
	/**
	 * Adds the parameter point to be the (i + 1)th point away from the current 'from'
	 * vertex of this edge.
	 * @param i
	 * @param point
	 */
