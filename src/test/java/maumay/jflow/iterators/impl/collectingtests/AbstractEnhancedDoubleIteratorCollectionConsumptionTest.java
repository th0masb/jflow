 ...
 *
 */
package maumay.jflow.iterators.impl.collectingtests;
 ...
 * @author ThomasB
 */
class AbstractEnhancedDoubleIteratorCollectionConsumptionTest
		extends IteratorExampleProvider
{
	@ParameterizedTest
	@MethodSource("collectToArrayTestDataProvider")
	void testCollectToArray(final AbstractEnhancedDoubleIterator iterator,
	...
	void testCollectToMap(final AbstractEnhancedDoubleIterator iterator,
	...
	void testGroupBy(final AbstractEnhancedDoubleIterator iterator,
