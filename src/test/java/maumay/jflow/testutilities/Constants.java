...
final class Constants
{
	...
	static final String[] SMALL_OBJECT_EXAMPLE_SRC = { "10", "11" };
	static final int[] SMALL_INT_EXAMPLE_SRC = { 10, 11 };
	static final double[] SMALL_DOUBLE_EXAMPLE_SRC = { 10, 11 };
	static final long[] SMALL_LONG_EXAMPLE_SRC = { 10, 11 };

	static final String[] LARGE_OBJECT_EXAMPLE_SRC = { "10", "11", "12", "13", "14",
			"15" };
