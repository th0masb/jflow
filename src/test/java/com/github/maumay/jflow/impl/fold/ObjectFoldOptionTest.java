 ...
 *
 */
public class ObjectFoldOptionTest extends AbstractObjectCollectionTest<String, Optional<String>>
{
	@Override
	...
	protected List<Case<String, Optional<String>>> getTestCases()
	{
		return list(new Case<>(list("a", "b"), Optional.of("ab")),
				new Case<>(list("a"), Optional.of("a")), new Case<>(list(), Optional.empty()));
	}
