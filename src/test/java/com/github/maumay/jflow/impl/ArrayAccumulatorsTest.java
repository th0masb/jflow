...
class ArrayAccumulatorsTest
{
    ...
    {
        return Iter.args(Arguments.of(10), Arguments.of(20), Arguments.of(21),
                Arguments.of(39),
                Arguments.of(12009));
    }
    ...
    {
        ArrayAccumulators.OfDouble acc = ArrayAccumulators
    ...
    {
        ArrayAccumulators.OfLong acc = ArrayAccumulators
    ...
    {
        ArrayAccumulators.OfObject<Integer> acc = ArrayAccumulators
    ...
    void testObjectCombining(Integer upperBound, Double split)
    {
        ...
        ArrayAccumulators.OfObject<Integer> a = ArrayAccumulators
                .createObjectAccumulator();
        ArrayAccumulators.OfObject<Integer> b = ArrayAccumulators
                .createObjectAccumulator();
        Integer[] expected = new Integer[upperBound];
        for (int i = 0; i < upperBound; i++) {
            expected[i] = i;
    ...
    {
        return Iter.args(Arguments.of(36, 0.5), Arguments.of(241, 0.3),
                Arguments.of(241, 0.9));
    }
}
