 ...
 *
 */
public final class ObjectPackTest extends AbstractObjectCollectionTest<Integer, Vec<Vec<Integer>>>
{
	@Override
	...
	{
		return list(new Case<>(list(1, 2), vec()), new Case<>(list(1, 2, 3), vec(vec(1, 2, 3))),
				new Case<>(list(1, 2, 3, 4, 5), vec(vec(1, 2, 3))),
				new Case<>(list(1, 2, 3, 4, 5, 6, 7), vec(vec(1, 2, 3), vec(4, 5, 6))));
	}
