 ...
 *
 */
public final class ApplicationSourceTest extends AbstractSourceTest<AbstractRichIterator<Integer>>
{
	@Override
	protected List<Case<AbstractRichIterator<Integer>>> getTestCases()
	{
		return list(new Case<>(() -> new ApplicationSource.OfObject<>(n -> 2 * n, 1).take(3),
				list(1, 2, 4)));
	}
}
