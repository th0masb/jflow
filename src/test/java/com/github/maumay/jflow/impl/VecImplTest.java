...
class VecImplTest extends AbstractCollectionBuilder
{
    ...
    void testEquals()
    {
        ...
        assertEquals(new VecImpl<>("a", "b", "c"),
                new VecImpl<>("a", "b", "c"));
    ...
    void testPartition()
    {
        ...
        assertEquals(Tup.of(vec(1, 2, 3), vec(4, 5, 6)),
                vector.partition(n -> n < 4));
    ...
    void testToSet()
    {
        assertEquals(new HashSet<>(list("a", "b")),
                new VecImpl<>("a", "a", "b").toSet());
    }

    @Test
    void testToList()
    {
        assertEquals(list("a", "a", "b"),
                new VecImpl<>("a", "a", "b").toList());
    }
    ...
    void testAll()
    {
        assertEquals(Boolean.TRUE,
                new VecImpl<Integer>(1, 2, 3).all(n -> n < 4));
        assertEquals(Boolean.FALSE,
                new VecImpl<Integer>(1, 2, 3).all(n -> n < 3));
    }
    ...
    {
        assertEquals(Boolean.TRUE,
                new VecImpl<Integer>(1, 2, 3).any(n -> n > 2));
        assertEquals(Boolean.FALSE,
                new VecImpl<Integer>(1, 2, 3).any(n -> n > 3));
    }
    ...
    {
        assertEquals(Boolean.FALSE,
                new VecImpl<Integer>(1, 2, 3).none(n -> n > 2));
        assertEquals(Boolean.TRUE,
                new VecImpl<Integer>(1, 2, 3).none(n -> n > 3));
    }
