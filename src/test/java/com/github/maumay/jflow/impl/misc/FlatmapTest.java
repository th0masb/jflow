 ...
 *
 */
public class FlatmapTest extends AbstractObjectAdapterTest<Integer, AbstractRichIterator<String>>
{
	@Override
	protected List<Case<Integer, AbstractRichIterator<String>>> getTestCases()
	{
		...
		return list(new Case<>(list(), adapter, list()), new Case<>(list(0, 0), adapter, list()),
