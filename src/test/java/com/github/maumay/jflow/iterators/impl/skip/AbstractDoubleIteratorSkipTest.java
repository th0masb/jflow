 ...
 * @author t
 */
public class AbstractDoubleIteratorSkipTest extends IteratorExampleProvider implements IteratorTest
{
	@Test
	void test()
	{
		double[][] expectedOutcomesForDifferentIndexArguments = { { 0, 1, 2, 3, 4 }, { 1, 2, 3, 4 },
				{ 2, 3, 4 }, { 3, 4 }, { 4 }, {}, };
	...
	private AbstractIterableDoubles createSkipIteratorProviderFrom(AbstractIterableDoubles src,
			int skipCount)
	{
