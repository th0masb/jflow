 ...
 *
 */
package xawd.jflow.iterators.abstractflows.collectionconsumptiontests;
...
class AbstractIntFlowCollectionConsumptionTest extends IteratorExampleProvider
{
	...
	static Stream<Arguments> collectToMapTestDataProvider()
	{
		...
		return Stream.of(
				Arguments.of(
						getSmallIntTestIteratorProvider().iter(),
						keyMapper,
						valueMapper,
				...
				Arguments.of(
						getEmptyIntTestIteratorProvider().iter(),
						keyMapper,
						valueMapper,
						asList()
						)
	...
	static Stream<Arguments> groupByTestDataProvider()
	{
		...
		return Stream.of(
				Arguments.of(getIntTestIteratorProvider().iter(), classifier, asList(Pair.of(0, new int[] {0, 2, 4}), Pair.of(1, new int[] {1, 3}))),
