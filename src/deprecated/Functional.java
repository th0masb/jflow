...
public final class Functional {
	...
	// }
	//
	// public static DoubleStream dloop(final double lower, final double upper,
	// final double step) {
	...
	// }
	//
	// public static DoubleStream dpartition(final double lower, final double upper,
	// final int nSubInterval) {
	...
	// }
	//
	// public static <T> List<T> zipMerge(final List<? extends T> one, final List<?
	// extends T> two) {
	...
	// }
	//
	// public static double[] mapToDouble(final IntToDoubleFunction f, final int[]
	// xs) {
	...
	// }
	//
	// public static double[] mapToDouble(final DoubleUnaryOperator f, final
	// double[] xs) {
	// final double[] result = new double[xs.length];
	// for (int i = 0; i<xs.length; i++) {
	// result[i] = f.applyAsDouble(xs[i]);
